...
public class ManoJsonTypeDescriptor extends AbstractTypeDescriptor<Object> implements DynamicParameterizedType {
	private static final long serialVersionUID = 1L;

	private static final Logger LOG = LoggerFactory.getLogger(ManoJsonTypeDescriptor.class);

	public static final ManoJsonTypeDescriptor INSTANCE = new ManoJsonTypeDescriptor();
	...
	private transient ManoObjectMapper objectMapperWrapper;

	public ManoJsonTypeDescriptor() {
		super(Object.class);
	}

//	public ManoJsonTypeDescriptor(final Type type) {
//		this();
//		setPropertyClass(type);
//	}

//	public ManoJsonTypeDescriptor(final ManoObjectMapper objectMapperWrapper) {
...
//	public ManoJsonTypeDescriptor(final ManoObjectMapper objectMapperWrapper, final Type type) {
...
//	}
	...
	public void setParameterValues(final Properties parameters) {
		...
		final Type type = (xProperty instanceof final JavaXMember jn) ? jn.getJavaType() : ((ParameterType) parameters.get(PARAMETER_TYPE)).getReturnedClass();
		setPropertyClass(type);
	}
	...
	public Object fromString(final String string) {
		if (propertyClass == null) {
			throw new HibernateException(
					"""
							The propertyClass in JsonTypeDescriptor is null,\s\
							hence it doesn't know to what Java Object type\s\
	...
	private void setPropertyClass(Type type) {
		...
		if (type instanceof final ParameterizedType pt) {
			...
			type = tv.getGenericDeclaration().getClass();
		}
